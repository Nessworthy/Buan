...
abstract class Extension {
	...
	*/
	...
	#
	# Do NOT call this constructor directly. Use ::getExtendionByName() instead.
	#
	...
	*/
	final public static function getAvailableList() {
		...
		$extensions = array();
		$extFolders = array(Config::get('app.dir.extensions'), Config::get('core.dir.extensions'));
	...
	*/
	final public static function getExtensionByName($extName) {
		...
		$extFolders = array('app'=>Config::get('app.dir.extensions'), 'core'=>Config::get('core.dir.extensions'));
		foreach($extFolders as $namespace=>$extFolder) {
			...
			else if(!isset($extensions[$extName])) {
				include_once("$extFolder/$extName/$extClassName.php");
