...
class ModelCriteria
{
    ...
    public function addClause($clause, $fieldName, $fieldValue = null, $valueIsReference = false)
    {
        ...
        if (func_num_args() < 3) {
            $this->whereGroup->addClause($clause, $fieldName);
            return null;
        }
        $this->whereGroup->addClause($clause, $fieldName, $fieldValue, $valueIsReference);
        return null;
    }
    ...
    {
        $this->whereGroup->addClauseLiteral($clause);
    }
