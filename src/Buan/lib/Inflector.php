...
class Inflector
{
    ...
    */
    ...
    static public function modelField_classMethod($fieldName)
    {
        ...
        // Conversion cache
        static $convCache = [];
        if (isset($convCache[$fieldName])) {
            return $convCache[$fieldName];
        }
     ...
     * Conversion: StringInputParam > stringInputParam
     *
     * @param string $classMethod Class method in UpperCamelCaps format
     * @return string
     */
     ...
     * Conversion: string-input-param > stringInputParam
     *
     * @param string $actionCommand Action as used in the URL command in lower-underscored format
     * @return string
     */
